...
@section('content')
<div class="container-fluid border-bottom" ng-app="ProjectAdminApp" ng-controller="FormCreateCtrl as ctrl" id="project-admin-form-edit">
  <div class="row">
    <div class="col-md-offset-1 col-md-10 border-left-right">
      <ol class="breadcrumb project-admin-breadcrumb text-uppercase">
        ...
        <li class="breadcrumb-item">
          <a ng-bind="ctrl.formData.formName"></a>
        </li>
        <li class="breadcrumb-item">
          <a>CREATE</a>
        </li>
     ...
     <form>
      ...
      <div class="form-group row" ng-repeat="(index, field) in ctrl.formData.fields">
        ...
        <dynamic-field
          ...
          mode="'edit'"
          value="ctrl.formData.formFieldValues[field.id]"
      ...
      <div class="row">
        ...
        <div class="project-admin-image-section">
          ...
          <form-images-edit
            media-groups="ctrl.formData.mediaGroups"
          >
          </form-images-edit>
      ...
      <div class="form-group row">
        <div class="col-sm-10">
          <button type="submit" class="btn project-admin-submit-btn" ng-click="ctrl.submitForm()">Submit</button>
