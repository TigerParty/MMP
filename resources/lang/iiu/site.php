...
return array(
    ...
    */
    'shorthead_title' => 'IIU',
    'shorthead_subtitle' => '',
    'title'   => 'Republic of Liberia Infrastructure Implementation Unit (IIU)',
    'subtitle'   => 'MINISTRY OF PUBLIC WORKS MONITORING, MAPPING, AND CITIZENS\' FEEDBACK PORTAL',
    'subject' => 'Smarter monitoring for a smarter Ghanna!',
    'email_name' => 'Ministry of Local Govt and Rural Dev',
    ...
    */
    ...
    'navigator' => array(
        ...
        'sms_intro' => array(
            'text' => 'To send a SMS to Ministry, text',
    ...
    'map' => array(
        ...
        'tutorial' => array(
            'Show Issues' => array('img' => '/images/map_tutorial_project.png',
                                     'description' => 'When you check "Show Issues", all issues will appear with blue dot icons.'),
            ...
            'Choose Category' => array('img' => '/images/map_tutorial_cgy.png',
                                       'description' => 'You can choose any category on the left. The issue under the category you choose will appear with a blue dot on the map.')
        )
    ),
