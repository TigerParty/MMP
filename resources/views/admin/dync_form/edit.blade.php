...
@section('js_block')
    <script>
        window.init_data = {
            'dynamic_form' : {!! old() ? json_encode(old()) : $dynamic_form !!},
...
<div class="container form-create-edit">
    <div ng-app="DyncFormApp" ng-controller="EditCtrl">

        <div class="row ">
            <h3 class="col-md-12 sub-header">{{ Lang::get('form.dynamic_form.title.edit') }}</h3>
        </div>
        ...
        <form action="{{ asset("/admin/dync_form/$dynamic_form->id") }}" method="POST">
        ...
        {{ csrf_field() }}
            ...
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control"
                        name="dynamic_form[name]"
                        ng-model="dynamic_form.name"
                    >
                </div>
                ...
                <div class="col-md-4">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"
                                name="dynamic_form[is_photo_required]"
                                ng-model="dynamic_form.is_photo_required"
                                ng-value="1"
                            >
                        </label>
                    </div>
            ...
            <div class="row form-group">
                <h4 class="control-label col-md-2">
                    {{ Lang::get('form.dynamic_form.component.fields') }}
                </h4>
                <hr>
            </div>
            ...
            <div ng-repeat="(f_idx, field) in dynamic_form.fields">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-7">
                        <p ng-if="field.template.id == 5 || field.template.id == 9" style="color:red;font-weight: bold">(Please note: This data field cannot be displayed in batch data)</p>
                    </div>
                    <div class="col-md-3">
                        <button type="button"
                            class="btn btn-default pull-right"
                            ng-click="deleteDyncField(f_idx)"
                        >
                            Delete This Field
                        </button>
                    </div>
                ...
                <div class="row form-group">
                    <label class="col-md-2 position-adjust">
                        {{ Lang::get('form.dynamic_form.dync_field.name') }}
                    </label>

                    <div class="col-md-4">
                        <input type="text"
                            class="form-control"
                            name="dynamic_form[fields][<% f_idx %>][name]"
                            ng-model="field.name"
                        >
                    </div>

                    <label class="col-md-2 position-adjust">
                        {{ Lang::get('form.dynamic_form.dync_field.template_type.name') }}
                    </label>

                    <div class="col-md-4">
                        <select class="form-control" name="dynamic_form[fields][<% f_idx %>][template]"
                        ...
                        >
                            <option value="">
                                {{ Lang::get('form.dynamic_form.dync_field.template_type.select') }}
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <label class="col-md-2 position-adjust">
                        {{ Lang::get('form.dynamic_form.dync_field.default') }}
                    </label>

                    <div class="col-md-4">
                        <input type="text"
                            class="form-control"
                            name="dynamic_form[fields][<% f_idx %>][default_value]"
                ...
                <div class="row form-group">
                    <label class="col-md-2 position-adjust">
                        {{ Lang::get('form.admin.edit_level.name') }}
                    </label>

                    <div class="col-md-4">
                        <select class="form-control"
                            name="dynamic_form[fields][<% f_idx %>][edit_level]"
                    ...
                    <label class="col-md-2 position-adjust">
                        {{ Lang::get('form.admin.view_level.name') }}
                    </label>

                    <div class="col-md-4">
                        <select class="form-control" name="dynamic_form[fields][<% f_idx %>][view_level]"
                ...
                <div class="row form-group" ng-show="field.isShowOptions">
                    <label class="col-md-2">
                        {{ Lang::get('form.dynamic_form.dync_field.options') }}
                    </label>
                    <div class="col-md-10">
                ...
                <div class="well well-sm" ng-show="field.showing_if_panel == 1">
                    <div class="form-inline">
                        ...
                        <select class="form-control" name="dynamic_form[fields][<% f_idx %>][show_if][field_id]" ng-change="getSourceFieldOptions(field.show_if)" ng-model="field.show_if.field_id">
                        ...
                        <select class="form-control" name="dynamic_form[fields][<% f_idx %>][show_if][equals]" ng-model="field.show_if.equals" ng-options="option for option in field.show_if.options track by option">
                            <option value="">{{ Lang::get('form.dynamic_form.dync_field.show_if.select_answer') }}</option>
                        </select>
                        <span style="color:red;font-weight: bold;margin-left:20px;">(Please note: This data field cannot be displayed in batch data)</span>
                    </div>
                </div>
                <hr>
            </div>
            ...
            <div class="row form-group">
                <div class="col-md-5">
                    <a class="btn btn-default" href="{{ asset('/admin/dync_form') }}" >
                        {{ Lang::get('form.btn.cancel') }}
                    </a>
                    <input type="submit"
                        value="{{ Lang::get('form.btn.submit') }}"
