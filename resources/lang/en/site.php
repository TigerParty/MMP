...
return [
    ...
    */
    ...
    'shorthead_title' => 'ARGO',
    'title'   => 'Argo Wantok Testing Environment',
    'subtitle'   => 'SMARTER MONITOR - SMARTER CONTRY',
    'subject' => 'Smarter monitoring!',
    'email_name' => 'Copyright TigerParty',
    ...
    */
    ...
    'map' => array(
        ...
        'tutorial' => array(
            'Show Projects' => array('img' => '/images/map_tutorial_project.png',
                'description' => 'When you check "Show Projects", all issues will appear with blue dot icons.'),
